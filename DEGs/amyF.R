...
amy_files<-list.files(directory)[grep(pattern = "F.*amy|F.*AMY", x = list.files(directory))]
...
#[1] 0.9717143 0.9472461 0.9569107 1.0097871 1.0099334 1.0043074 0.9689890 0.9828545 1.0015503
#[10] 1.0594912 0.9808705 1.0281651 1.0143274 1.0305031 0.9982684 1.0155089 1.0128048 1.0134467
...
contr.matrix <- makeContrasts(amy_V_F_vs_amy_C_F = V - C,
...
#write.table(v$E, "~/voom_amy_F.txt", sep = "\t")
