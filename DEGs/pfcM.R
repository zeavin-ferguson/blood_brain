...
pfc_files<-list.files(directory)[grep(pattern = "M-.*pfc|M-.*pfc", x = list.files(directory))]
...
#[1] 0.9920979 1.0032461 0.9726219 1.0764009 0.9768858 0.9933919 0.9884627 1.0059064 0.9899583
#[10] 1.0120371 0.9857156 0.9995953 1.0019668 1.0025496 1.0429838 0.9881910 0.9833143 0.9896429
...
contr.matrix <- makeContrasts(pfc_V_M_vs_pfc_C_M = V - C,
...
#write.table(v$E, "~/voom_pfc_M.txt", sep = "\t")
