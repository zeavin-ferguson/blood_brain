...
hyp_files<-list.files(directory)[grep(pattern = "M-.*hyp|M-.*hyp", x = list.files(directory))]
...
# [1] 1.0070244 0.9655850 0.9856919 1.0416873 0.9649996 0.9731575 1.0012783 1.0100624 1.0284662
# [10] 1.0181449 1.0134892 0.9656815 0.9982885 1.0031948 1.0179373 0.9968431 0.9858700 1.0271084
...
contr.matrix <- makeContrasts(hyp_V_M_vs_hyp_C_M = V - C,
...
#write.table(v$E, "~/voom_hyp_M.txt", sep = "\t")
